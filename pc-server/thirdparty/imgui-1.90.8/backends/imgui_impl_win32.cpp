...
static BOOL _IsWindowsVersionOrGreater(WORD major, WORD minor, WORD)
{
	...
	return (RtlVerifyVersionInfoFn((OSVERSIONINFOEXW*)&versionInfo, VER_MAJORVERSION | VER_MINORVERSION, conditionMask) == 0) ? TRUE : FALSE;
}
...
{
    // Function body disabled because dwmapi.h is missing in MinGW
}
